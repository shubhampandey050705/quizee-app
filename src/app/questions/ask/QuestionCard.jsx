...
const QuestionCard = ({ ques }) => {
  ...
  const ref = React.useRef(null); // Ref to get height of the card for animation

  // Measure height of the card once it's rendered
  React.useEffect(() => {
    if (ref.current) {
    ...
    >
      ...
      <div className="relative w-full">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3 text-sm">
          ...
          {/* Relative time since question was asked */}
          <span>
